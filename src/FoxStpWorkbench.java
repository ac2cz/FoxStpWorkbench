...
public class FoxStpWorkbench {

	public static String HELP = "AMSAT Fox STP Analysis Tool. Version " + Config.VERSION +"\n\n"
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					...
					seriousErrorMsg = "Something is preventing the AMSAT STP Analysis Tool from running.  If you recently changed something\n"
							+ "try reverting to an older version, or install the standard files.  \n"
							+ "If that does not work then you can try deleting the stpTool.properties\n"
